    ...
    public class LinqSamples
    {
        ...
        */
        ...
        public void Przyklad2()
        {
            ...
            var res2 = Emps.Where(x => x.Job == "Frontend programmer" && x.Salary > 1000).Select(x => new
            {
                Nazwisko = x.Ename,
                Zawod = x.Job,
                Salary = x.Salary
        ...
        public void Przyklad3()
        {
            ...
            var res2 = Emps.Where(x => x.Salary == Emps.Max(x => x.Salary)).Select(x => new
            {
                Imie = x.Ename,
                Salary = x.Salary
            });
        ...
        {
            var res = Emps.Aggregate(new Emp(), (i, next) => next.Salary > i.Salary ? next : i, emp => emp.Ename);
            Console.WriteLine(res);
        }
        ...
        {
            var res = Emps.SelectMany(x => Depts.Select(y => Tuple.Create(x, y)));
            foreach (var i in res)
            {
                Console.WriteLine(i);
            }
